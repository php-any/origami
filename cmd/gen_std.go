...
var genStdOutput string

var genStdCmd = &cobra.Command{
	Use:   "gen-std",
...
示例:
  ...
  zy gen-std -o docs/std`,
	RunE: func(cmd *cobra.Command, args []string) error {
		return pseudocode.Generate(genStdOutput)
	},
}

func init() {
	genStdCmd.Flags().StringVarP(&genStdOutput, "output", "o", ".zy/std", "伪代码输出目录")
}
