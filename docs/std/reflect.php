...
class Reflect {
     ...
     * 
     */
    public function getClassAnnotations($className) : string {
        // 实现逻辑
    }
     ...
     * 
     */
    public function getMethodAnnotations($className, $methodName) : string {
        // 实现逻辑
    }
     ...
     * 
     */
    public function getPropertyAnnotations($className, $propertyName) : string {
        // 实现逻辑
    }
     ...
     * 
     */
    public function getAllAnnotations($className) : string {
        // 实现逻辑
    }
     ...
     * 
     */
    public function getAnnotationDetails($className, $memberType, $memberName) : string {
        // 实现逻辑
    }
