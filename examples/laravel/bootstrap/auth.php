...
if (!function_exists('auth_set_token')) {
...
if (!function_exists('auth_set_request')) {
...
if (!function_exists('auth_current_token')) {
...
/**
 * 仅当 Foundation helpers 未定义 auth() 时提供 fallback。
 *
 * @param  string|null  $guard
 * @return AuthGuard|AuthFactory|AuthManager
 */
...
if (!function_exists('bootstrap_auth')) {
    function bootstrap_auth(): void
    {
        ...
        if (!$app->bound('hash')) {
            ...
            $app->alias('hash', Hasher::class);
            $app->alias('hash', HashManager::class);
        }
        ...
        $app->alias('auth', AuthFactory::class);
        $app->alias('auth', AuthManager::class);
    }
}
