<div class="max-w-2xl">
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-lg font-semibold mb-6">{{ $permissionId ? '编辑权限' : '新建权限' }}</h2>

        <form wire:submit="save">
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">名称</label>
                    <input type="text" wire:model="name" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="如：users.view">
                ...
                <div>
                    ...
                    <input type="text" wire:model="group" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="如：user">
                ...
                <div class="flex space-x-3 pt-4">
                    ...
                    <a href="{{ route('admin.permissions.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-md text-sm hover:bg-gray-400">取消</a>
                </div>
            </div>
        </form>
    </div>
