...
class PageController {
    ...
    public function about(Response $response): void {
        $this->render($response, "about");
    }

    #[GetMapping(path: "/products")]
    public function products(Response $response): void {
        $this->render($response, "products");
    }

    #[GetMapping(path: "/contact")]
    public function contact(Response $response): void {
        $this->render($response, "contact");
    }

    #[GetMapping(path: "/chat")]
    public function chat(Response $response): void {
