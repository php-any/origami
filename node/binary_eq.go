...
func NewBinaryEq(from data.From, left, right data.GetValue) *BinaryEq {
	return &BinaryEq{
		Node:  NewNode(from),
		Left:  left,
		Right: right,
...
func (b *BinaryEq) GetValue(ctx data.Context) (data.GetValue, data.Control) {
