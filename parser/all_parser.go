...
var parserRouter = map[token.TokenType]func(parser *Parser) StatementParser{
	...
	token.EXIT:           NewExitParser,
	token.DIE:            NewExitParser,
	...
	token.CLASS_MAGIC:    NewClassMagicParser,
	token.FILE:           NewFileParser,
	token.LINE:           NewLineParser,
	token.FUNCTION_MAGIC: NewFunctionMagicParser,
	...
	token.READONLY:      NewReadonlyParser,
