...
func NewResultClass() data.ClassStmt {
	return &ResultClass{
		source:       nil,
		lastInsertId: &ResultLastInsertIdMethod{source: nil},
		rowsAffected: &ResultRowsAffectedMethod{source: nil},
	}
}
...
func (s *ResultClass) GetProperties() map[string]data.Property    { return nil }
