...
func Load(vm data.VM) {
	...
	for _, fun := range []data.FuncStmt{
		...
		NewOpenSSLCipherIVLengthFunction(),
		NewOpenSSLEncryptFunction(),
		NewOpenSSLDecryptFunction(),
		NewMtSrandFunction(),
		NewMtRandFunction(),
		NewSrandFunction(),
		NewRandFunction(),
		...
		core.NewObCleanFunction(),
		core.NewObEndFlushFunction(),
		core.NewObFlushFunction(),
		core.NewObGetFlushFunction(),
		core.NewObGetLengthFunction(),
		...
		NewDeg2radFunction(),
		NewRad2degFunction(),
		NewBaseConvertFunction(),
		NewBindecFunction(),
		NewStrWordCountFunction(),
		NewWordwrapFunction(),
		NewStrShuffleFunction(),
		NewStrRot13Function(),
		NewAddslashesFunction(),
		NewChopFunction(),
		NewQuotemetaFunction(),
		NewNl2brFunction(),
		NewSubstrCompareFunction(),
		NewHtmlentitiesFunction(),
		NewHtmlspecialcharsDecodeFunction(),
		NewAddcslashesFunction(),
		NewMetaphoneFunction(),
		NewSoundexFunction(),
		NewSimilarTextFunction(),
		NewDateFunction(),
		NewMktimeFunction(),
		NewGmmktimeFunction(),
		NewCheckdateFunction(),
		NewGetdateFunction(),
		NewPrintRFunction(),
		NewPrintfFunction(),
		NewVprintfFunction(),
		NewIsExecutableFunction(),
		NewFilectimeFunction(),
		NewFileatimeFunction(),
		NewFilepermsFunction(),
		NewFileownerFunction(),
		...
		array.NewArrayIntersectUkeyFunction(),
	} {
		vm.AddFunc(fun)
	}
