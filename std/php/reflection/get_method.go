...
var reflectionClassGetMethodMethodGetParams = []data.GetValue{
...
func (m *ReflectionClassGetMethodMethod) GetParams() []data.GetValue {
	return reflectionClassGetMethodMethodGetParams
}

var reflectionClassGetMethodMethodGetVariables = []data.Variable{
	node.NewVariable(nil, "name", 0, data.String{}),
}

// GetVariables 返回变量列表
func (m *ReflectionClassGetMethodMethod) GetVariables() []data.Variable {
	return reflectionClassGetMethodMethodGetVariables
}
