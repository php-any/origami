...
var reflectionClassGetMethodsMethodGetParams = []data.GetValue{
...
func (m *ReflectionClassGetMethodsMethod) GetParams() []data.GetValue {
	return reflectionClassGetMethodsMethodGetParams
}

var reflectionClassGetMethodsMethodGetVariables = []data.Variable{
	node.NewVariable(nil, "filter", 0, data.NewBaseType("?int")),
}

// GetVariables 返回变量列表
func (m *ReflectionClassGetMethodsMethod) GetVariables() []data.Variable {
	return reflectionClassGetMethodsMethodGetVariables
}
