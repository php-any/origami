...
var reflectionAttributeGetArgumentsMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionAttributeGetArgumentsMethod) GetParams() []data.GetValue {
	return reflectionAttributeGetArgumentsMethodGetParams
}

var reflectionAttributeGetArgumentsMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionAttributeGetArgumentsMethod) GetVariables() []data.Variable {
	return reflectionAttributeGetArgumentsMethodGetVariables
}
