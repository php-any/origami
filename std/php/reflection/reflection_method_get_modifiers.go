...
var reflectionMethodGetModifiersMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionMethodGetModifiersMethod) GetParams() []data.GetValue {
	return reflectionMethodGetModifiersMethodGetParams
}

var reflectionMethodGetModifiersMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionMethodGetModifiersMethod) GetVariables() []data.Variable {
	return reflectionMethodGetModifiersMethodGetVariables
}
