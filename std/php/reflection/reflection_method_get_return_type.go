...
var reflectionMethodGetReturnTypeMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionMethodGetReturnTypeMethod) GetParams() []data.GetValue {
	return reflectionMethodGetReturnTypeMethodGetParams
}

var reflectionMethodGetReturnTypeMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionMethodGetReturnTypeMethod) GetVariables() []data.Variable {
	return reflectionMethodGetReturnTypeMethodGetVariables
}
