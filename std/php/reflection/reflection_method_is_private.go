...
var reflectionMethodIsPrivateMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionMethodIsPrivateMethod) GetParams() []data.GetValue {
	return reflectionMethodIsPrivateMethodGetParams
}

var reflectionMethodIsPrivateMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionMethodIsPrivateMethod) GetVariables() []data.Variable {
	return reflectionMethodIsPrivateMethodGetVariables
}
