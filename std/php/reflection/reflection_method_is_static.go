...
var reflectionMethodIsStaticMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionMethodIsStaticMethod) GetParams() []data.GetValue {
	return reflectionMethodIsStaticMethodGetParams
}

var reflectionMethodIsStaticMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionMethodIsStaticMethod) GetVariables() []data.Variable {
	return reflectionMethodIsStaticMethodGetVariables
}
