...
var reflectionMethodSetAccessibleMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表
func (m *ReflectionMethodSetAccessibleMethod) GetParams() []data.GetValue {
	return reflectionMethodSetAccessibleMethodGetParams
}

var reflectionMethodSetAccessibleMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionMethodSetAccessibleMethod) GetVariables() []data.Variable {
	return reflectionMethodSetAccessibleMethodGetVariables
}
