...
var reflectionParameterGetPositionMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionParameterGetPositionMethod) GetParams() []data.GetValue {
	return reflectionParameterGetPositionMethodGetParams
}

var reflectionParameterGetPositionMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionParameterGetPositionMethod) GetVariables() []data.Variable {
	return reflectionParameterGetPositionMethodGetVariables
}
