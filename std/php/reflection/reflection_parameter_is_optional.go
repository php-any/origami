...
var reflectionParameterIsOptionalMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionParameterIsOptionalMethod) GetParams() []data.GetValue {
	return reflectionParameterIsOptionalMethodGetParams
}

var reflectionParameterIsOptionalMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionParameterIsOptionalMethod) GetVariables() []data.Variable {
	return reflectionParameterIsOptionalMethodGetVariables
}
