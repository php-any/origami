...
var reflectionParameterIsVariadicMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionParameterIsVariadicMethod) GetParams() []data.GetValue {
	return reflectionParameterIsVariadicMethodGetParams
}

var reflectionParameterIsVariadicMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionParameterIsVariadicMethod) GetVariables() []data.Variable {
	return reflectionParameterIsVariadicMethodGetVariables
}
