...
var reflectionTypeConstructMethodGetParams = []data.GetValue{}
...
func (m *ReflectionTypeConstructMethod) GetParams() []data.GetValue {
	return reflectionTypeConstructMethodGetParams
}

var reflectionTypeConstructMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表
func (m *ReflectionTypeConstructMethod) GetVariables() []data.Variable {
	return reflectionTypeConstructMethodGetVariables
}
