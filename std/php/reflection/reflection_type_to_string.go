...
var reflectionTypeToStringMethodGetParams = []data.GetValue{}

// GetParams 返回参数列表，该方法无参数
func (m *ReflectionTypeToStringMethod) GetParams() []data.GetValue {
	return reflectionTypeToStringMethodGetParams
}

var reflectionTypeToStringMethodGetVariables = []data.Variable{}

// GetVariables 返回变量列表，该方法无变量
func (m *ReflectionTypeToStringMethod) GetVariables() []data.Variable {
	return reflectionTypeToStringMethodGetVariables
}
