...
var striposFunctionGetParams = []data.GetValue{
...
func (f *StriposFunction) GetParams() []data.GetValue {
	return striposFunctionGetParams
}

var striposFunctionGetVariables = []data.Variable{
...
func (f *StriposFunction) GetVariables() []data.Variable {
	return striposFunctionGetVariables
}
